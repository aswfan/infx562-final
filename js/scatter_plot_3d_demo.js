function scatterPlot3d( parent )
{
  ...
  var colorSchema = {'a': 'steelblue', 'b': 'red', 'c': 'yarm'};
  ...
  d3v3.csv("data/3data.csv", data => {
    ...
    var rows = data.filter(d => d.step === step);
    ...
    function plotData( duration ) {
      ...
      rows = data.filter(d => d.step === step);
      ...
      datapoints.selectAll("shape appearance material")
          .attr("diffuseColor",  (row) => { return colorSchema[row.label] }) //'steelblue'
