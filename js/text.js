...
page0.append('p')
    ...
    .append('p')
    .text("PCA refers to the process by which principal component analysis are computed, and the subsequent use of these components in understanding the data.")
    .append('p')
    ...
    .append('p')
    .text("The first principal component of a set of features X1,X2, . . . , Xp is the normalized linear combination of the features.")
